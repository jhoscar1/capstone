...
export default class PublicArt extends Component {
	...
	static navigationOptions = (props) => {
		...
		return {
			headerRight: <Icon name="ios-map" size={30} iconStyle={marginLeft=20}
	...
	render() {
		...
		return (<View style={styles.container}>
					<AppCamera tilt={this.state.gyro} pois={this.state.nearbyPois} position={this.state.position}
							heading={this.state.heading} navigation={navigation} />
	  			</View>);
	}
}
